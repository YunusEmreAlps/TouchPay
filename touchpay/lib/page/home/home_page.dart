...
import 'package:touchpay/page/search/search_page.dart';
import 'package:touchpay/util/app_constant.dart';
import 'package:touchpay/util/app_widget.dart';
import 'package:touchpay/util/system_overlay.dart';
import 'package:touchpay/widget/homepage/bottom_sheet.dart';
import 'package:touchpay/widget/homepage/search_box.dart';
import 'package:touchpay/widget/homepage/tdk_cover.dart';
import 'package:touchpay/widget/homepage/home_page_list_view.dart';
          ...
          children: <Widget>[
            new RawMaterialButton(
              ...
              child: new Icon(Icons.arrow_back_ios,
                  color: AppConstant.colorBackButton, size: 13.0),
            ...
            children: <Widget>[
              ...
              Center(
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text(AppConstant.appDescription,
            ...
            children: <Widget>[
              Padding(
                ...
                child: MaterialButton(
                  ...
                  child: Text(AppConstant.hakkinda,
                      style: TextStyle(
                          fontSize: 14,
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  shape: RoundedRectangleBorder(
                      borderRadius: new BorderRadius.circular(8)),
                  child: Text(AppConstant.contact,
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppConstant.colorHeading)),
  ...
  Widget _renderItem(StateSetter setState) => Column(
        children: <Widget>[
            ...
            child: PageView(
              ...
              children: <Widget>[
                AppBottomSheetWidgets.buildIletisimItem(
                    _itemTopMenu(AppConstant.contactDetails)),
          ...
          AppBottomSheetWidgets.selectCategory(
              _horizontalCategoryItem(id: 0, title: AppConstant.contact),
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            height: MediaQuery.of(context).size.height * .5,
            child: Container(
              child: AppBottomSheetWidgets.buildHakkindaItem(
