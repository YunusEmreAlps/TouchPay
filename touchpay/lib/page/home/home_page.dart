        ...
        children: <Widget>[
          Expanded(
            child: PageView(
              ...
              children: <Widget>[
                AppBottomSheetWidgets.buildIletisimItem(_itemTopMenu(AppConstant.contactDetails)),
                AppBottomSheetWidgets.buildKatkiItem(_itemTopMenu(AppConstant.katkioneri))
              ],
            ),
          ),
          AppBottomSheetWidgets.selectCategory(
              _horizontalCategoryItem(id: 0, title: AppConstant.contact), _horizontalCategoryItem(id: 1, title: AppConstant.katkioneri))
        ],
      );
